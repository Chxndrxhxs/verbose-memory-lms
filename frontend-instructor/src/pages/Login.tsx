    ...
    <div className="min-h-screen bg-[#f6f5f1] flex items-center justify-center p-3 sm:p-4">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[28px] bg-white shadow-sm lg:grid-cols-2">
        <div className="relative hidden lg:block">
          <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=900" alt="" className="h-full w-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
          <div className="absolute bottom-6 left-6 right-6 rounded-2xl bg-white p-4 shadow-xl">
            <p className="text-sm font-bold">Teach what you know</p><p className="text-xs text-zinc-500">Share skills, grow your audience, earn on your terms.</p>
          </div>
        </div>
        <div className="flex flex-col p-8 sm:p-10">
          ...
          <h1 className="mt-8 text-2xl font-extrabold tracking-tight">Instructor login</h1>
