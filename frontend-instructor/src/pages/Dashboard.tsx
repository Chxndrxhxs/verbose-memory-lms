    ...
    <div className="min-h-screen bg-[#f6f5f1]">
      ...
      <div className="mx-auto max-w-[1080px] px-3 py-6 sm:px-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <Link to="/courses/new" className="rounded-full bg-[#0f172a] px-5 py-2.5 text-sm font-bold text-white">+ Create course</Link>
        </div>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1fr_340px]">
          <div className="rounded-[20px] bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-3">
              {[
                ...
                ["James Park", "Business Leadership", "5h ago", "$29"],
                ["Sara Kim", "Python Basics", "1d ago", "$19"],
          ...
          <div className="rounded-[20px] bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 grid gap-2">
              <Link to="/courses/new" className="rounded-xl border bg-zinc-50 p-4 hover:bg-white"><p className="text-sm font-bold">Create new course</p><p className="text-xs text-zinc-500">Start from scratch</p></Link>
