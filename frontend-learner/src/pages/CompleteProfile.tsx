...
export default function CompleteProfile() {
  ...
  useEffect(() => {
    // if no user (cookie missing), bounce to login
    if (!user) {
    ...
    <div className="min-h-screen bg-[#f6f5f1] flex items-center justify-center p-3 sm:p-4">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[28px] bg-white shadow-sm lg:grid-cols-[1.1fr_0.9fr]">
        <div className="p-8 sm:p-10">
          ...
          <h1 className="mt-6 text-2xl font-extrabold tracking-tight">Complete your profile</h1>
          <p className="text-sm text-zinc-500">Tell us a bit about you — helps personalize your learning.</p>
