    ...
    <div className="min-h-screen w-full bg-[#f6f5f1] lg:grid lg:grid-cols-2">
      <div className="flex min-h-screen flex-col bg-white px-6 py-8 sm:px-10 lg:px-16 lg:py-12">
        ...
        <div className="flex flex-1 items-center">
          <div className="mx-auto w-full max-w-md">
            <h1 className="text-3xl font-extrabold tracking-tight text-zinc-900">Complete your profile</h1>
            <p className="mt-2 text-sm text-zinc-500">Tell us a bit about you — helps personalize your learning.</p>
      ...
      <div className="relative hidden h-screen lg:block">
        ...
        <div className="absolute bottom-10 left-10 right-10 text-white">
          <p className="text-3xl font-extrabold leading-tight tracking-tight">Your journey<br/>starts here.</p>
          <p className="mt-3 max-w-sm text-sm text-white/80">Personalized paths, calm sessions, real progress — built around how you actually learn.</p>
